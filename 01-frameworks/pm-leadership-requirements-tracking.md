---
title: How to Keep Track of Requirements
summary: A framework for capturing, triaging, and managing a growing requirements list so nothing gets lost, forgotten, or endlessly re-raised
tags: [leadership, product-management, requirements, jira, process]
status: stable
last_updated: 2026-04-14
ai_context: |
  Standalone piece for the pm-leadership GitHub repo. Written in the context of
  a team using Jira and Microsoft Copilot, with Jira Product Discovery unavailable
  for requirements tracking (repurposed for NNL board). Uses a Jira Epic as a
  requirements registry and Copilot as an intake layer.
---
...
### B — A single Jira Epic as the requirements registry
